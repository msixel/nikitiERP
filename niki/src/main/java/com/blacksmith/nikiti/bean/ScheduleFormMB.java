...
@Named
@ViewScoped
public class ScheduleFormMB extends CrudMB<Schedule> implements Serializable {
    ...
    public void afterRemove() {
        try {
            ...
            Faces.redirect("schedule/schedule-list.xhtml");
            clear(); 
            sessionFilter.clear(ScheduleFormMB.class.getName());//removes filter saved in session for this bean.
        } catch (Exception e) {
