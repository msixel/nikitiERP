...
public class CityEndpoint {
	...
	public Response create(City entity) {
		...
		return Response.created(
				UriBuilder.fromResource(CityEndpoint.class)
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<City> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT c FROM City c LEFT JOIN FETCH c.province WHERE c.id = :entityId ORDER BY c.id",
						City.class);
	...
	@GET
	@Produces("application/json")
	public List<City> listAll(@QueryParam("start") Integer startPosition,
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") Long id, City entity) {
		if (entity == null) {
