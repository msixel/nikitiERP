...
public class CompanyEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Company> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT c FROM Company c LEFT JOIN FETCH c.country LEFT JOIN FETCH c.province LEFT JOIN FETCH c.city LEFT JOIN FETCH c.neighborhood LEFT JOIN FETCH c.employees WHERE c.id = :entityId ORDER BY c.id",
						Company.class);
