...
public class EmployeeEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Employee> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT e FROM Employee e LEFT JOIN FETCH e.country LEFT JOIN FETCH e.province LEFT JOIN FETCH e.city LEFT JOIN FETCH e.neighborhood LEFT JOIN FETCH e.position LEFT JOIN FETCH e.schedule LEFT JOIN FETCH e.company WHERE e.id = :entityId ORDER BY e.id",
						Employee.class);
	...
	public List<Employee> listAll(@QueryParam("start") Integer startPosition,
		...
		final List<Employee> results = findAllQuery.getResultList();
		return results;
	}
